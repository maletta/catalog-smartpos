  ...
  if (offlinePayment) {
    if (isNaturalPerson) {
      return yup.object().shape({
        ...
        tipoEndereco: yup.object().required(),
        estado: yup
          .string()
          .min(2)
          .max(50)
          .required(),
        pagamento: yup.object().required(),
      });
    }
  ...
  if (isNaturalPerson) {
    return yup.object().shape({
      ...
      endereco: yup
        ...
        .required()
        .max(150),
      cobrancaEndereco: yup
        .string()
        .required()
        .max(150),
      complemento: yup.string().max(50),
      cobrancaComplemento: yup.string().max(50),
      numero: yup.number().required(),
      cobrancaNumero: yup.number().required(),
      bairro: yup
        .string()
        .required()
        .max(100),
      cobrancaBairro: yup
        ...
        .max(100),
      cidade: yup.string().required(),
      cobrancaCidade: yup.string().required(),
      tipoEndereco: yup.object().required(),
      estado: yup
        .string()
        .min(2)
